defmodule Cog.Resources do
  ...
  @spec get_resource(integer) :: Resource.t | nil
  def get_resource(id), do: Cog.Repo.get(Resource, id)
  ...
  @spec get_field(integer) :: ResourceField.t | nil
  def get_field(id), do: Cog.Repo.get(ResourceField, id)

  @spec list_fields() :: list(ResourceField)
  def list_fields, do: Cog.Repo.all(ResourceField)

  @spec create_field(map) :: {:ok, ResourceField.t} | {:error, Ecto.Changeset.t}
